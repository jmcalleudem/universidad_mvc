...
namespace universidad_mvc.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public CarrerasController(universidad_mvcContext context)
        {
            _context = context;
        }
        ...
        {
            var universidad_mvcContext = _context.Carrera.Include(c => c.Facultad);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,FechaCreacion,Nivel,FacultadId")] Carrera carrera)
        {
            ...
            ViewData["FacultadId"] = new SelectList(_context.Set<Facultad>(), "Id", "Id", carrera.FacultadId);
            return View(carrera);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,FechaCreacion,Nivel,FacultadId")] Carrera carrera)
        {
            if (id != carrera.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'universidad_mvcContext.Carrera'  is null.");
            }
            var carrera = await _context.Carrera.FindAsync(id);
            if (carrera != null)
            {
