...
namespace universidad_mvc.Controllers
{
    public class CursosController : Controller
    {
        ...
        public CursosController(universidad_mvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Curso != null ? 
                          ...
                          Problem("Entity set 'universidad_mvcContext.Curso'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'universidad_mvcContext.Curso'  is null.");
            }
            var curso = await _context.Curso.FindAsync(id);
            if (curso != null)
            {
